...
export function InteractiveBackground({ variant = "gradient", className = "" }: InteractiveBackgroundProps) {
  ...
  useEffect(() => {
    ...
    if (variant === "parallax") {
      ...
      layers.forEach((layer, index) => {
        const speed = Number.parseFloat(layer.getAttribute("data-parallax") || "0.5")
    ...
    return (
      <div ref={containerRef} className={`fixed inset-0 -z-10 overflow-hidden ${className}`}>
        <div
          ...
          style={{
            backgroundImage: "url('/palm-leaves-silhouette.jpg')",
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/sun-haze-over-lagoon.jpg')",
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
        />
