...
export default function robots(): MetadataRoute.Robots {
  return {
    rules: [
      // Standard render-aware search engine crawlers (need /_next/static/)
      ...
      // Agentic AI and LLM crawlers (need /_next/static/ for full rendering and visual hierarchy)
      ...
      { userAgent: "Manus", allow: ["/", "/_next/static/"] }, // Agentic Browser
