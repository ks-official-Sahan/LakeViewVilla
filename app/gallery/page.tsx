...
export const metadata: Metadata = {
  ...
  description: "View Tangalle villa photos. Lake View Villa Tangalle gallery features images of our serene lagoon views, A/C rooms, and beautiful natural surroundings.",
