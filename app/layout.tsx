...
export const metadata: Metadata = {
  ...
  description: "Book Lake View Villa Tangalle. A private vacation rental offering scenic lagoon views, A/C bedrooms, fast Wi-Fi, and chef service in Sri Lanka.",
  keywords: [
