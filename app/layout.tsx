...
export const metadata: Metadata = {
  ...
  description: "Lake View Villa Tangalle is a private vacation rental and lodging business offering comfortable stays with lagoon views in Tangalle, Sri Lanka.",
  keywords: [
    "Lake View Villa",
    "Tangalle villa",
    "Sri Lanka stay"
  ...
  openGraph: {
    ...
    images: [
      { url: "/villa/optimized/drone_view_villa.webp", width: 1200, height: 630, alt: "Lake View Villa Tangalle — Lagoon view" },
    ],
  },
  twitter: {
